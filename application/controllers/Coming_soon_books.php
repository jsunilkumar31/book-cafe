 ...
 * Home page
 */
class Coming_soon_books extends MY_Controller {
	...
	public function index()
	{
        ...
        $this->data["csbook"] = $this->home_model->getcomingsoonbooks(24);
        // echo '<pre>';
        //   var_export($this->data["csbook"]);
        //   echo '</pre>'; exit;
        $this->load->view('template_morden/header', $this->data);
        //$this->load->view('template_morden/navigation', $this->data);
        $this->load->view('coming-soon-books', $this->data);
