...
class Home extends MY_Controller
{
    ...
    public function wishlist($category_id) {
    ...
    public function addBookToWishlist(){
        ...
        $book_info = $this->home_model->getBookByID($book_id);

        $user_info = $this->mUser;
    ...
    private function sendEmail($mailData){
        ...
        $mailSubject = 'New Wishlist Request Submitted by '.$mailData['username'];
        
        // Mail content
        $mailContent = '
            <h2>New Wishlist Request Submitted</h2>
            <p><b>Username: </b>'.$mailData['username'].'</p>
            <p><b>Email: </b>'.$mailData['email'].'</p>
            <p><b>Mobile: </b>'.$mailData['mobile'].'</p>
            <p><b>User Id: </b>'.$mailData['user_id'].'</p>
            <p><b>Book Id: </b>'.$mailData['book_id'].'</p>
            <p><b>Book Title: </b>'.$mailData['book_title'].'</p>
        ';
