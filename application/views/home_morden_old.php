                        ...
                        <ul id="newrealease-slider" class="list-inline p-0 m-0 d-flex align-items-center">
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/01.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/02.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/03.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/04.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/05.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/06.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/07.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/08.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>
                            </li>
                            <li class="item">
                                <a href="javascript:void(0);">
                                    <img src="<?= base_url(); ?>assets/front-theme/images/new_realeases/09.jpg" class="img-fluid w-100 rounded" alt="">
                                </a>                              
                            </li>
                        </ul>
                    </div>
