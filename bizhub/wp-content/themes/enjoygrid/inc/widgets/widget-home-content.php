 ...
 * @since      1.0.0
 */
class EnjoyGrid_Home_Content_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-enjoygrid-home-block-one',
			'description' => __( 'Display post content blocks. Only use for the "Home Content" widget area.', 'enjoygrid' )
		);

		// Create the widget.
		parent::__construct(
			'enjoygrid-home-block-one',          // $this->id_base
			__( '&raquo; Home Content', 'enjoygrid' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo esc_html( $this->get_field_id('col') ); ?>">
				...
				<?php esc_html_e( '3 Columns Layout', 'enjoygrid' ); ?>		    	
			</label>		    
		<br/>
			<label for="<?php echo esc_html( $this->get_field_id('col') ); ?>">
		    	...
		    	<?php esc_html_e( '4 Columns Layout', 'enjoygrid' ); ?>
			</label>		    
	    </p>
